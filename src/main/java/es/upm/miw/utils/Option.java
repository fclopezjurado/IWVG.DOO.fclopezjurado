 ...
 */
public enum Option {
	MOVE_FROM_DECK_TO_WASTE("Mover de baraja a descarte"), 
	MOVE_FROM_WASTE_TO_DECK("Mover de descarte a baraja"), 
	MOVE_FROM_WASTE_TO_FOUNDATION("Mover de descarte a palo"), 
	MOVE_FROM_WASTE_TO_PILE("Mover de descarte a escalera"), 
